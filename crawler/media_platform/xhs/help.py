...
# 使用统一的路径工具获取 douyin.js 文件路径
douyin_js_path = get_resource_path("crawler/libs/douyin.js")

# 验证文件是否存在
if not validate_file_path(douyin_js_path):
    raise FileNotFoundError(f"找不到文件: {douyin_js_path}")
